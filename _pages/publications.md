...
## Talks and Posters
  1. Takumi Kobori, Yasunari Suzuki, <u>Yosuke Ueno</u>, Teruo Tanimoto, Synge Todo, Yuuki Tokunaga,
   <br> "LSQCA: Resource-Efficient Load/Store Architecture for Limited-Scale Fault-Tolerant Quantum Computing",
  <br> 4th Quantum Computing Theory in Practice conference. <span style="color: red; "> (QCTiP 2025 poster) </span>

  1. Shin Nishio, Ryo Wakizaka, Daisuke Sakuma, <u>Yosuke Ueno</u>, Yasunari Suzuki,
  <br> "Online Job Scheduler for Fault-tolerant Quantum Multiprogramming",
  <br> 4th Quantum Computing Theory in Practice conference. <span style="color: red; "> (QCTiP 2025 poster) </span>
...
## Invited Talks
  ...
  1. <u>Yosuke Ueno</u>, Takayuki Hoshi, Atsushi Hiyama, and Masahiko Inami,
   ...
   <br> 24th International Display Workshops (IDW), 2017.
...
## Invited Talks (in Japanese)
  ...
  1. <u>上野洋典</u>,
   ...
   <br> 第22回情報科学技術フォーラム（FIT2023）, 2023年9月. (招待講演) [[資料]](/files/FIT2023.pdf)
...
## Talks and Posters (in Japanese)
  ...
  <br>"格子手術に基づく誤り耐性量子計算の長距離配線による効率化",
  <br>第252回情報処理学会システム・アーキテクチャ研究会, 2025. （ポスター）

  1. 西尾真, 脇坂遼, 佐久間大輔, <u>上野洋典</u>, 鈴木泰成,
  <br>"フォールトトレラント量子マルチプログラミングのためのオンラインスケジューラ",
  <br>第14回情報処理学会量子ソフトウェア研究会, 2025.
